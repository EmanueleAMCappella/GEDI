...
P = nx.Graph()
P.add_nodes_from([
                  (1, {'pos': [2, 4], 'text':'Chatbot - Potenziatori: UA'}),
                  (2, {'pos': [4, 3], 'text':'IVR - Potenziatori: UA'}),
                  (3, {'pos': [2, 7], 'text':'Upselling&Cross-selling - Potenziatori: UA'}),
                  (4, {'pos': [6.5, 7], 'text':'Dynamic Adv - Potenziatori: UA'}),
                  (5, {'pos': [9.5, 8], 'text':'Dynamic Paywall - Potenziatori: UA'}),
                  (6, {'pos': [7, 9.5], 'text':'User Clustering - Potenziatori: UA'}),
                  (7, {'pos': [2, 10.5], 'text':'Augmented Search - Potenziatori: UA'}),
                  (8, {'pos': [3, 15], 'text':'Ottimizzazione - Potenziatori: UA'}),
                  (9, {'pos': [5.5, 15], 'text':'Scenario Analysis - Potenziatori: UA'}),
                  (10, {'pos': [13, 10], 'text':'Customer Journey - Potenziatori: UA'}),
                  (11, {'pos': [9.5, 11.5], 'text':'NBA per Acquisition - Potenziatori: UA'}),
                  (12, {'pos': [11, 14], 'text':'NBA per CC - Potenziatori: UA'}),
                  (13, {'pos': [14, 15], 'text':'Cost Forecast - Potenziatori: UA'}),
                  (14, {'pos': [16, 17], 'text':'Smart Closing - Potenziatori: UA'}),
                  (15, {'pos': [17, 15], 'text':'Revenue Forecast - Potenziatori: UA'}),
                  (16, {'pos': [18, 12.5], 'text':'Churn - Potenziatori: UA'}),
                  (17, {'pos': [4.5, 17], 'text':'Personalizzazione Offerta - Potenziatori: UA'}),
                  (18, {'pos': [11, 3], 'text':'Social Curation - Potenziatori: UA'}),
                  (19, {'pos': [13, 5], 'text':'Social Alert - Potenziatori: UA'}),
                  (20, {'pos': [15.5, 7.5], 'text':'Smart Archive - Potenziatori: UA'}),
                  (21, {'pos': [19, 5], 'text':'Reality Bridge - Potenziatori: UA'}),
                  (22, {'pos': [16, 4], 'text':'Ticket AutoRouting - Potenziatori: UA'}),
                  (23, {'pos': [15, 2], 'text':'Content Tagging - Potenziatori: UA'})
                  ])
